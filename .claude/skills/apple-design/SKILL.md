...
_principles_ are universal; the _implementation details_ vary by platform.
...
When asked to _improve_ a design (not just review), follow the review process first, then:
